...
import { fetchUploadHistory, historyUrls, type UploadHistoryItem } from "@/lib/api/history";
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <p className="uppercase tracking-[2.4px] text-xs font-semibold text-[var(--accent)]">History</p>
      ...
      <div className="bg-[var(--panel)] rounded-3xl border border-[rgba(193,121,255,0.22)] p-8 shadow-[var(--shadow-soft),0_0_0_1px_rgba(142,92,255,0.08)_inset] space-y-4">
        ...
        <div className="grid gap-4">
          {items.map((item) => {
            ...
            return (
              <article key={item.id} className="rounded-3xl border border-white/[0.08] bg-white/5 p-5">
                <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    <a
                      ...
                      className="inline-flex items-center justify-center rounded-full bg-gradient-to-r from-violet-500 to-fuchsia-500 px-4 py-2 text-sm font-semibold text-white shadow-[0_18px_40px_rgba(168,85,247,0.25)] transition hover:scale-[1.02]"
                    >
                      Download again
                    </a>
