      ...
      <section className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
        ...
        <div className="relative mx-auto w-full max-w-md overflow-hidden rounded-[2rem] border border-violet-300/20 bg-[linear-gradient(180deg,rgba(20,13,43,0.95),rgba(10,8,20,0.96))] p-8 shadow-[0_30px_80px_rgba(10,7,24,0.65)]">
          ...
          <div className="relative space-y-6">
            <img className="mx-auto w-56 rounded-[2rem] border border-white/10 bg-white/5 object-contain p-3 shadow-[0_0_30px_rgba(184,110,255,0.28)]" src="/hero.png" alt="RBX Royale Community logo" />
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {[
                ...
                <div key={title} className="rounded-2xl border border-white/[0.08] bg-white/5 p-4">
